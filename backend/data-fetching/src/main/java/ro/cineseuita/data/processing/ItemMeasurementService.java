...
public class ItemMeasurementService {
  ...
  @Autowired
  public ItemMeasurementService(DirectAcquisitionContractFetchService directAcquisitionContractFetchService,
  ...
  void addItemMeasurementClassToAllContractItems() {
    ...
    System.out.println("There were a total of " + i[0] + " items. Out of these, " + i[1] + "(" + perc + "%) were in a" +
        " defined bucked and " + (i[0] - i[1]) + " were put in the general class.");
  }
