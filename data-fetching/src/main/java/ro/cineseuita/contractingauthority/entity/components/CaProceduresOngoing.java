...
public class CaProceduresOngoing {
    ...
    private Long simplifiedProcedureBids;
    @JsonProperty("total")
    private Long total;
    @JsonIgnore
    ...
    @JsonProperty("simplifiedProcedureBids")
    public Long getSimplifiedProcedureBids() {
        return simplifiedProcedureBids;
    }

    @JsonProperty("simplifiedProcedureBids")
    public void setSimplifiedProcedureBids(Long simplifiedProcedureBids) {
